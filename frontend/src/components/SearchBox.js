		...
		<section className='search'>
			...
			<form action='#' className='search__form'>
				<div className='search__group'>
					<input type='text' name='name' id='name' className='search__group--input' placeholder='Name' required />
				...
				<div className='search__group'>
					<input type='text' name='phone' id='phone' className='search__group--input' placeholder='phone' />
				...
				<div className='search__group'>
					<input type='text' name='email' id='email' className='search__group--input' placeholder='email' />
